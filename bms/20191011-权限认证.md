转载自[JavaGuide](https://snailclimb.top/JavaGuide/#/docs/system-design/authority-certification/basis-of-authority-certification)



## [1. 认证 (Authentication) 和授权 (Authorization) 的区别是什么？](https://snailclimb.top/JavaGuide/#/docs/system-design/authority-certification/basis-of-authority-certification?id=_1-认证-authentication-和授权-authorization的区别是什么？)
...
## [2. 什么是 Cookie ? Cookie 的作用是什么？如何在服务端使用 Cookie ?](https://snailclimb.top/JavaGuide/#/docs/system-design/authority-certification/basis-of-authority-certification?id=_2-什么是cookie-cookie的作用是什么如何在服务端使用-cookie-)

### [2.1 什么是 Cookie ? Cookie 的作用是什么？](https://snailclimb.top/JavaGuide/#/docs/system-design/authority-certification/basis-of-authority-certification?id=_21-什么是cookie-cookie的作用是什么)

Cookie 和 Session 都是用来跟踪浏览器用户身份的会话方式，但是两者的应用场景不太一样。

维基百科是这样定义 Cookie 的：Cookies 是某些网站为了辨别用户身份而储存在用户本地终端上的数据（通常经过加密）。简单来说： **Cookie 存放在客户端，一般用来保存用户信息**。
...
### [2.2 如何能在 服务端使用 Cookie 呢？](https://snailclimb.top/JavaGuide/#/docs/system-design/authority-certification/basis-of-authority-certification?id=_22-如何能在-服务端使用-cookie-呢？)

这部分内容参考：[https://attacomsian.com/blog/cookies-spring-boot，更多如何在 Spring](https://attacomsian.com/blog/cookies-spring-boot，更多如何在Spring) Boot 中使用 Cookie 的内容可以查看这篇文章。
...
## [3. Cookie 和 Session 有什么区别？如何使用 Session 进行身份验证？](https://snailclimb.top/JavaGuide/#/docs/system-design/authority-certification/basis-of-authority-certification?id=_3-cookie-和-session-有什么区别？如何使用session进行身份验证？)
...
## [4. 什么是 Token? 什么是 JWT? 如何基于 Token 进行身份验证？](https://snailclimb.top/JavaGuide/#/docs/system-design/authority-certification/basis-of-authority-certification?id=_4-什么是-token什么是-jwt如何基于token进行身份验证？)
...
## [5 什么是 OAuth 2.0？](https://snailclimb.top/JavaGuide/#/docs/system-design/authority-certification/basis-of-authority-certification?id=_5-什么是oauth-20？)
...
## [参考](https://snailclimb.top/JavaGuide/#/docs/system-design/authority-certification/basis-of-authority-certification?id=参考)
